...
void main() {
  ...
  test('deviceConnectionCandidates honors remembered-first route policy', () {
    const device = Device(
      id: 'desk',
      name: 'Desk PC',
      host: '192.168.0.10',
      ...
      preferredRouteHost: '100.64.0.10',
      lastSuccessfulRouteHost: '100.64.0.10',
      networkRoutes: <NetworkRoute>[
        NetworkRoute(
          host: '192.168.0.10',
          friendlyName: 'Wi-Fi',
    ...
    expect(
      candidates.map((NetworkRoute route) => route.host).toList(),
      <String>['100.64.0.10', '192.168.0.10'],
    );
  });
}
