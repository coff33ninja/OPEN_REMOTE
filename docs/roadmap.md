...
- Agent startup, config, and health endpoints.
- Pairing session issuance and token exchange.
...
- Remote sync between agent and client.
- Full JSON renderer for all supported control primitives.
- Macro definitions and multi-step execution.
- Local storage for favorites, recent agents, and saved layouts.
